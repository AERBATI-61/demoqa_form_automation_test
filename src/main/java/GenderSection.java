...
public class GenderSection extends BasePage{
    ...
    private final By maleRadioLabelLocator = By.cssSelector("label[for='gender-radio-1']");
    private final By femaleRadioLabelLocator = By.cssSelector("label[for='gender-radio-2']");
    private final By otherRadioLabelLocator = By.cssSelector("label[for='gender-radio-3']");
